...
class AnnouncementController {
  ...
  public image(@BodyParam('sessionId', { required: true }) sessionId: number): Promise<{ image: Image }> {
    return null;
  }
  ...
  public result(@BodyParam('sessionId', { required: true }) sessionId: number): Promise<{ session: Session }> {
    return null;
  }
}
